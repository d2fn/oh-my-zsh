...
alias zu='zeus test/units/*'
alias zunits='zeus test/units/*'

alias zf='zeus test/functional/*'
alias zunctional='zeus test/functional/*'

alias za='zeus test test/units/*; zeus test test/functional/; zeus cucumber'
alias zall='zeus test test/units/*; zeus test test/functional/; zeus cucumber'
